...
void ROSBotController::targetAngularVelocityCallback_(const edubot::WheelAngularVelocityPair &target_velocity_message)
{
    // Set PID target to the desired target velocity
    motor_controller_left_.setTargetStateValue(target_velocity_message.wheel_angular_velocity_left);
    motor_controller_right_.setTargetStateValue(target_velocity_message.wheel_angular_velocity_right);
}
