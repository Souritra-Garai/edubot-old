...
class ROSBotController
{
    private :
        ...
        ros::Subscriber<edubot::WheelAngularVelocityPair, ROSBotController> target_angular_velocity_subscriber_;
        void targetAngularVelocityCallback_(const edubot::WheelAngularVelocityPair &target_angular_velocity_message);
        
        edubot::WheelAngularVelocityPair current_angular_velocity_message_;
