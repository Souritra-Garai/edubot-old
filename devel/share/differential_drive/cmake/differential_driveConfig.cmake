...
if("TRUE" STREQUAL "TRUE")
  set(differential_drive_SOURCE_PREFIX /home/souritra/edubot/src/differential_drive)
  set(differential_drive_DEVEL_PREFIX /home/souritra/edubot/devel)
  ...
  set(differential_drive_INSTALL_PREFIX /home/souritra/edubot/install)
...
if(NOT "/home/souritra/edubot/devel/include;/home/souritra/edubot/src/differential_drive/include;/home/souritra/edubot/src/differential_drive/include/differential_drive " STREQUAL " ")
  set(differential_drive_INCLUDE_DIRS "")
  set(_include_dirs "/home/souritra/edubot/devel/include;/home/souritra/edubot/src/differential_drive/include;/home/souritra/edubot/src/differential_drive/include/differential_drive")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'souritra <souritra.garai@iitgn.ac.in>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'differential_drive' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/souritra/edubot/src/differential_drive/${idir}'.  ${_report}")
    endif()
    _list_append_unique(differential_drive_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "differentialDrive")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/souritra/edubot/devel/lib;/home/souritra/edubot/devel/lib;/home/souritra/catkin_ws/devel/lib;/opt/ros/noetic/lib)
...
set(differential_drive_EXPORTED_TARGETS "differential_drive_generate_messages_cpp;differential_drive_generate_messages_eus;differential_drive_generate_messages_lisp;differential_drive_generate_messages_nodejs;differential_drive_generate_messages_py")
...
set(pkg_cfg_extras "differential_drive-msg-extras.cmake")
